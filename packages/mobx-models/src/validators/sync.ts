...
export const validators = {
  ...
  notNullCode<TModel extends BaseModel>(
  ...
  emailCode<TModel extends BaseModel>(
    code: ErrorCode = "errors:email"
  ): SyncValidator<string, TModel> {
  ...
  integer: ((value: number) =>
    Number.isInteger(value) ? null : "errors:integer") as SyncValidator<number, any>,

  // number (factory for custom code)
  integerCode<TModel extends BaseModel>(
